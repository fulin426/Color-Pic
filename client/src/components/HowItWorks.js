      ...
      <Grid.Row className="explanation-container">
        <Grid.Column >
          ...
          <p className="explanation-text">
            The Color Pic application uses image recognition from <a href="https://www.clarifai.com/models/color-image-recognition-model-eeed0b6733a644cea07cf4c60f87ebb7" target="_blank" rel="noopener noreferrer">Clarifai</a> to predict what the dominant colors are in a given picture.
